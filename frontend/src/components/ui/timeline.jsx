    ...
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-white max-w-4xl">
          AI Voice Analysis Technology
        </h2>
        <p
          className="text-gray-300 text-sm md:text-base max-w-sm">
          Our advanced voice analysis platform combines cutting-edge AI technology 
          with real-time processing to protect users from fraudulent calls.
        </p>
      </div>
          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                ...
                <div
                  className="h-4 w-4 rounded-full bg-gray-800 border border-gray-600 p-2" />
              </div>
              <h3
                className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-gray-300">
                {item.title}
              </h3>
            </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3
                className="md:hidden block text-2xl mb-4 text-left font-bold text-gray-300">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
